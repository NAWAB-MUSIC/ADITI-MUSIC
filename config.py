...
BOT_USERNAME = getenv("BOT_USERNAME" , "nawabXDmusic_bot")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/NAWAB-MUSIC/ADITI-MUSIC",)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+t7d-99_5j1wyY2Y9")
